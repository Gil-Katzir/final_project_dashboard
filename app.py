...
def save_initial_session_to_db():
    """
    Saves the initial session row immediately after participant ID is entered
    and the experiment group is assigned.
    """
    try:
        ...
        st.error("שגיאה בשמירת session ראשוני")
        st.code(str(e))
